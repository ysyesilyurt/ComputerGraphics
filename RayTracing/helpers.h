...
inline Vector3f vectorSum(Vector3f first, Vector3f second, int type = 0) 
{
	Vector3f res;
...
inline Vector3f vectorSubtract(Vector3f first, Vector3f second, int type = 0) 
{
	Vector3f res;
...
inline Vector3f scalarMultipleVector(float scale, Vector3f vector, int type = 0) 
{
	Vector3f res;
...
inline int dotProduct(Vector3f first, Vector3f second) 
{
	return (first.x*second.x + first.y*second.y + first.z*second.z);
}


inline Vector3f crossProduct(Vector3f first, Vector3f second) 
{
	Vector3f res;
